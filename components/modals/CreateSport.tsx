...
export default function CreateSportModal({
  ...
  const handleSubmit = () => {
    ...
    onSubmit(form);
    setForm({ name: "", description: "", requireJerseyNumber: false, requirePosition: false });
  };
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-[1px] flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md mx-4">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">Create Sport</h2>
          <button
            onClick={handleClose}
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="jersey-number" className="ml-2 text-sm text-gray-700">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                />
                <label htmlFor="position" className="ml-2 text-sm text-gray-700">
                  Require Position
                </label>
              </div>
            </div>
